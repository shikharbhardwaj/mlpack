...
#include <mlpack/methods/naive_bayes/parallel_naive_bayes_classifier.hpp>
...
BOOST_AUTO_TEST_SUITE(ParallelNBCTest);

BOOST_AUTO_TEST_CASE(ParallelNaiveBayesClassifierTest)
{
  ...
  ParallelNaiveBayesClassifier<> nbcTest(trainData, labels, classes);
...
// variance.
BOOST_AUTO_TEST_CASE(ParallelNaiveBayesClassifierIncrementalTest)
{
  const char* trainFilename = "trainSet.csv";
  const char* testFilename = "testSet.csv";
  const char* trainResultFilename = "trainRes.csv";
  ...
  ParallelNaiveBayesClassifier<> nbcTest(trainData, labels, classes, true);
...
BOOST_AUTO_TEST_CASE(SeparateTrainTest)
{
  ...
  ParallelNaiveBayesClassifier<> nbc(trainData, labels, classes, true);
  ParallelNaiveBayesClassifier<> nbcTrain(trainData.n_rows, classes);
