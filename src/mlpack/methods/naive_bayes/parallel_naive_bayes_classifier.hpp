 ...
 */
#ifndef MLPACK_METHODS_PARALLEL_NAIVE_BAYES_NAIVE_BAYES_CLASSIFIER_HPP
#define MLPACK_METHODS_PARALLEL_NAIVE_BAYES_NAIVE_BAYES_CLASSIFIER_HPP
...
class ParallelNaiveBayesClassifier
{
 public:
  /**
   ...
   * ParallelNaiveBayesClassifier nbc(training_data, labels, 5);
   * @endcode
   *
   ...
   */
  ParallelNaiveBayesClassifier(const MatType& data,
   ...
   * meaningless.
   */
  ParallelNaiveBayesClassifier(const size_t dimensionality = 0,
...
#include "parallel_naive_bayes_classifier_impl.hpp"
