 ...
 */
#ifndef MLPACK_METHODS_PARALLEL_NAIVE_BAYES_NAIVE_BAYES_CLASSIFIER_IMPL_HPP
#define MLPACK_METHODS_PARALLEL_NAIVE_BAYES_NAIVE_BAYES_CLASSIFIER_IMPL_HPP
